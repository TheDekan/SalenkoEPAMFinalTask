...
<script src="js/stoves.js"></script>
</head>
			...
			<form name="filterForm" ng-submit="sendFilter()" novalidate>
				...
				<div style="display: inline-block">
					...
					<div class="form-group" style="display: inline-block"
						...
						<label for="fspecialParameter1Min">Burner&nbsp;countMin:</label> <span
					...
					<div class="form-group" style="display: inline-block"
						...
						<label for="fspecialParameter1Max">Burner&nbsp;countMax:</label> <span
		...
		<div>
			<form ng-if="product.id != null" name="productForm"
				...
				<div class="form-group"
					...
					<label for="specialParameter1">Burner&nbsp;count:</label> <span
