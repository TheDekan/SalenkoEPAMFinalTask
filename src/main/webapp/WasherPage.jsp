...
<script src="js/washers.js"></script>
</head>
			...
			<form name="filterForm" ng-submit="sendFilter()" novalidate>
				...
				<div style="display: inline-block">
					...
					<div class="form-group" style="display: inline-block"
						...
						<label for="fspecialParameter1Min">Kilos&nbsp;loadMin:</label> <span
					...
					<div class="form-group" style="display: inline-block"
						...
						<label for="fspecialParameter1Max">Kilos&nbsp;loadMax:</label> <span
		...
		<div>
			<form ng-if="product.id != null" name="productForm"
				...
				<div class="form-group"
					...
					<label for="specialParameter1">Kilos&nbsp;load:</label> <span
