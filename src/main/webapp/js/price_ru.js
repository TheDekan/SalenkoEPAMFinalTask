...
app.controller('productsListController', function ($scope, $rootScope, productService) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            { field: 'specialParameter1', displayName: 'СП1' },
            { field: 'specialParameter2', displayName: 'СП2' },
...
app.controller('alertMessagesController', function ($scope) {
        ...
        $scope.alerts = [
            { type: 'success', msg: 'Продукт успешно сохранен!' }
        ];
    });

        $scope.$on('productDeleted', function () {
        $scope.alerts = [
            { type: 'success', msg: 'Продукт успешно удален!' }
        ];
    });
