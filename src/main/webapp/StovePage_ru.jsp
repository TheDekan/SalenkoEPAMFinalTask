...
<script src="js/stoves_ru.js"></script>
</head>
...
<body>
	...
	<div style="width: 100px; display:inline-block; float:left">
		<div id="wrapper">
			<ul class="menu2">
				<li><a href="Stove?action=start&locale=eng"><img src="https://purepetfood.co.uk/catalog/view/theme/pure/image/uk-small.png" style="height: 20px; width: 40px"/></a></li>
				<li><a href="Stove?action=start&locale=ru"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/f/f3/Flag_of_Russia.svg/1200px-Flag_of_Russia.svg.png" style="height: 20px; width: 40px"/></a></li>
			</ul>
		</div>
	</div>
	...
	<div class="grid2" ng-controller="stovesListController">
		<div>
		...
		<pagination direction-links="true" boundary-links="true"
			total-items="stoves.totalResults" items-per-page="stoves.pageSize"
			ng-model="stoves.currentPage" ng-change="refreshGrid()">
		</pagination>
		<div>
			<form name="filterForm" ng-submit="sendFilter()" novalidate>
				...
				<input type="hidden" name="ftype" ng-model="filter.ftype" ng-init="filter.ftype = 'stove'" />
				<div class="column">
				...
				<div class="column">
					<div class="form-group"
						...
						<label for="fspecialParameter2">Тип&nbsp;печи:</label> <span
				...
				<div style="display: inline-block">
					...
					<div class="form-group" style="display: inline-block"
						...
						<label for="fspecialParameter1Min">МинКол-во&nbsp;комфорок:</label> <span
					...
					<div class="form-group" style="display: inline-block"
						...
						<label for="fspecialParameter1Max">МаксКол-во&nbsp;комфорок:</label> <span
	...
	<div class="form2" ng-controller="stoveFormController">
		...
		<div>
			<form ng-if="product.id != null" name="productForm"
				...
				<div class="form-group"
					...
					<label for="specialParameter1">Количество&nbsp;комфорок:</label> <span
				...
				<div class="form-group"
					...
					<label for="specialParameter2">Тип&nbsp;печи:</label> <span
